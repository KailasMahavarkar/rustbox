...
mod tests {
    ...
    fn test_strict_mode_requires_root_privileges() {
        #[cfg(unix)]
        {
            ...
            if result.is_err() {
                ...
                assert!(error_msg.contains("root") || error_msg.contains("permission"), 
                       "Error should mention root privileges or permissions, got: {}", error_msg);
            } else {
            ...
            if !getuid().is_root() {
                ...
                if result.is_err() {
                    ...
                    assert!(error_msg.contains("root") || 
                           ...
                           "Error should mention root, cgroup, or permission issues, got: {}", error_msg);
                } else {
    ...
    fn test_default_non_strict_behavior() {
        ...
        assert!(!config.strict_mode, "Default config should have strict_mode = false");
